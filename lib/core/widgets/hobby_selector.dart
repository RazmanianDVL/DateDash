    ...
    return Column(
      ...
      children: [
            ...
            return Animate(
              ...
              child: GlassmorphicContainer(
                ...
                linearGradient: LinearGradient(
                  colors: [Colors.pinkAccent.withOpacity(0.3), Colors.cyanAccent.withOpacity(0.2)],
                ),
                borderGradient: const LinearGradient(colors: [Color(0xFFFF2D95), Color(0xFF00F0FF)]),
                child: Chip(
        ...
        GlassmorphicContainer(
          ...
          borderGradient: LinearGradient(colors: [Color(0xFFFF2D95), Color(0xFF00F0FF)]),
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.search, color: Color(0xFFFF2D95)),
                    ...
                    children: filteredHobbies.map((hobby) {
                      ...
                      return Animate(
                        ...
                        child: FilterChip(
                          ...
                          selectedColor: const Color(0xFFFF2D95),
                          labelStyle: TextStyle(
                            color: isSelected ? Colors.white : Colors.white70,
                            fontWeight: FontWeight.w600,
                          ),
                          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                          side: BorderSide(color: isSelected ? Colors.transparent : Colors.cyanAccent.withOpacity(0.5)),
                        ),
                      );
                    }).toList(),
                  ),
